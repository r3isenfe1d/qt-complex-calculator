...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(510, 550);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(MainWindow->sizePolicy().hasHeightForWidth());
        MainWindow->setSizePolicy(sizePolicy);
        MainWindow->setMinimumSize(QSize(510, 550));
        MainWindow->setMaximumSize(QSize(510, 550));
...
"background-color: rgb(94, 92, 100);"));
        ...
        labelNumbers->setMinimumSize(QSize(490, 110));
        labelNumbers->setMaximumSize(QSize(490, 110));
        QFont font;
...
""));
        ...
        labelNumbers->setTextFormat(Qt::MarkdownText);
        labelNumbers->setScaledContents(false);
        labelNumbers->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        labelNumbers->setWordWrap(true);
...
"}"));
        ...
        button_0->setMaximumSize(QSize(500, 70));
...
"}"));
        ...
        QWidget::setTabOrder(button_3, button_4);
        QWidget::setTabOrder(button_4, button_5);
        QWidget::setTabOrder(button_5, button_6);
        QWidget::setTabOrder(button_6, button_7);
        QWidget::setTabOrder(button_7, buttonC);
        QWidget::setTabOrder(buttonC, button_8);
        QWidget::setTabOrder(button_8, buttonHelp);
        QWidget::setTabOrder(buttonHelp, buttonDiv);
        QWidget::setTabOrder(buttonDiv, buttonMult);
        QWidget::setTabOrder(buttonMult, button_9);
        QWidget::setTabOrder(button_9, buttonPlus);
        QWidget::setTabOrder(buttonPlus, buttonMinus);
        QWidget::setTabOrder(buttonMinus, buttonDEL);
